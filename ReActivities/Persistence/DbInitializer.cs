        ...
        public static async Task SeedData(AppDbContext context, UserManager<User> userManager)
        {
            ...
            if (!userManager.Users.Any())
            {
                foreach (var user in users)
                {
                    ...
                    if (!result.Succeeded)
                    {
                        // Log failures to identify issues
            ...
            // Ensure users have their Ids refreshed from DB
            users = userManager.Users.ToList();

            // --- Seed Activities ---
            if (context.Activities.Any()) return; // Prevent duplicate seeding
            ...
            var activities = new List<Activity>
            {
                new()
                {
                    ...
                    Category = "drinks",
                    City = "London",
                    Venue = "The Lamb and Flag, 33 Rose Street, London, UK",
                    Latitude = 51.51171665,
                    Longitude = -0.12566110,
                    ActivityAttendees =
                    [
                ...
                new()
                {
                    ...
                    Category = "culture",
                    City = "Paris",
                    Venue = "Louvre Museum, Paris, France",
                    Latitude = 48.8611473,
                    Longitude = 2.3380276,
                    ActivityAttendees =
                    [
