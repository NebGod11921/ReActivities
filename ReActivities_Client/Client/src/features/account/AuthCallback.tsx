...
export default function AuthCallback() {
    ...
    return (
        <Paper sx={{height:400, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', p:3, gap:3, maxWidth:'md', mx: 'auto', borderRadius: 3}}>
            <Box display="flex"  alignItems='center' justifyContent='center' gap={3}>
                <GitHub fontSize="large"></GitHub>
                <Typography variant="h4">Logging in with GitHub</Typography>
            </Box>
            {loading ? <CircularProgress></CircularProgress>
                : <Typography>Problem signing in GitHub</Typography>
            }
